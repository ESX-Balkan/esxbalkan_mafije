...
Config.Locale  = 'hr'
Config.Levelanje = false -- Ovo stavite na true ako želite da mafije idu po levelima, za sada se na levelu 1 otkljucava pristup sefu
Config.lvl1 = 25000 -- ovo je cijena za upgrade na lvl 1
Config.MarkerTypes = {
	Brodovi = 35,
	BossMeni = 31,
	SpawnAuta = 36,
